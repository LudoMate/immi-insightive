    ...
    <SidebarProvider defaultOpen={true}>
      <div className="flex h-screen w-full overflow-hidden">
        <div className="hidden lg:block">
          <DashboardSidebar className="fixed top-0 bottom-0 left-0 w-[240px] xl:w-[260px] border-r border-gray-200 overflow-y-auto z-50 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-200" />
        </div>

        {/* Main Content */}
        <div className="flex-1 flex flex-col w-full lg:ml-[240px] xl:ml-[260px]">
                ...
                <div className="flex items-center gap-2 sm:gap-4">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="ghost" size="icon" className="relative hover:bg-gray-100/80">
                        ...
                        {notifications.some((n) => !n.read) && (
                          <span className="absolute -right-1 -top-1 flex h-3 w-3 sm:h-4 sm:w-4 items-center justify-center rounded-full bg-[#0066FF] text-[9px] sm:text-[10px] font-medium text-white">
                    ...
                    <DropdownMenuContent
                      ...
                      side="bottom"
                      sideOffset={5}
                      className="w-[320px] sm:w-[380px] p-2 bg-white rounded-lg shadow-lg border border-gray-200 z-[60]"
                    >
                      <DropdownMenuLabel className="flex items-center justify-between px-3 py-2 mb-1 border-b border-gray-100">
                        <span className="text-sm sm:text-base font-semibold text-gray-900">Notifications</span>
                        <Button
                          variant="ghost"
                          className="h-7 sm:h-8 px-2 sm:px-3 text-xs sm:text-sm font-medium text-[#0066FF] hover:text-white hover:bg-[#0066FF] transition-colors rounded-full"
                  ...
                  <Button
                    ...
                    className="hidden sm:inline-flex bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm text-sm"
                  >
                    <span className="hidden md:inline">Start New Application</span>

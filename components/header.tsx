...
const ImmiInsightiveLogo = () => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Globe */}
    <circle cx="20" cy="20" r="12" fill="#0066FF" fillOpacity="0.1" stroke="#0066FF" strokeWidth="2" />
    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          {/* Mobile menu button */}
          <button
            className="md:hidden p-2 hover:bg-[#0B1120]/5 rounded-lg transition-colors"
            ...
            <div className="flex flex-col space-y-6 md:flex-row md:items-center md:space-y-0 md:space-x-8">
              ...
              {isAuthenticated && (
                <div className="group relative">
                  ...
                  >
                    Profile <ChevronDown className="h-4 w-4 transition-transform duration-200 group-hover:rotate-180" />
                  </button>
                        ...
                        <Link href="/profile">
                          <div className="flex items-center px-3 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-[#0066FF] cursor-pointer gap-3 group">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-xs text-gray-500 group-hover:text-[#0066FF]/70">
                        ...
                        <div className="px-2 py-2 border-t border-gray-100 mt-1">
                          ...
                          >
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-xs text-gray-500 group-hover:text-red-600/70">
              ...
              <div className="relative group">
                ...
                >
                  Services <ChevronDown className="h-4 w-4 transition-transform duration-200 group-hover:rotate-180" />
                </button>
                <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="w-56 bg-white border border-gray-200 shadow-lg rounded-md overflow-hidden">
                    <div className="py-2">
                      ...
                      <Link href="/services/consultation">
                        <div className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 cursor-pointer">
                ...
                {!isAuthenticated && (
                  <>
                    ...
                    <Link href="/signup" className="block w-full md:hidden">
                      <Button className="w-full bg-[#0B1120] text-white hover:bg-blue-600 transition-colors">

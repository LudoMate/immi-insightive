          ...
          <Card className="bg-white border border-gray-200">
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <h4 className="font-medium text-gray-900">Document Submission</h4>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-4 h-4 rounded-full border-2 border-blue-600 bg-white mt-1 flex-shrink-0"></div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                    ...
                    <p className="text-sm text-gray-600">Estimated completion in 2 days</p>
                  </div>
                </div>

                {/* Interview Preparation - Upcoming */}
                <div className="flex items-start gap-4">
                  <div className="w-4 h-4 rounded-full border-2 border-gray-300 bg-white mt-1 flex-shrink-0"></div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
        ...
        <div className="w-80 space-y-6">
          ...
          <Card className="border border-gray-200">
            <CardHeader className="border-b border-gray-200">
              <CardTitle className="text-lg text-gray-900">Important Updates</CardTitle>
            </CardHeader>
            <CardContent className="p-4">
              <div className="space-y-4">
                ...
                <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                  ...
                  <p className="text-xs text-gray-600">Additional proof of employment needed</p>
                </div>
              </div>
            </CardContent>
          </Card>
